...
def game_worker(connection, args):
    ...
    #setup stockfish
    if args.stockfish > -1:
        #engine = chess.uci.popen_engine('/Users/Dan/dev/nd/senior/ml/project/sunfish/uci.py')
        engine = chess.xboard.popen_engine('/Users/Dan/dev/nd/senior/ml/project/sunfish/xboard.py')
        #engine.uci()
        engine.xboard()
        ...
        while not board.is_game_over(claim_draw=True):
            if player == 1:
                ...
                if args.stockfish == -1:
                    ...
                    #move, _ = engine.go(movetime=5000)
                    #move, _ = engine.go()
                    move = engine.go()
